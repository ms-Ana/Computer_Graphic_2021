...
const char* FragShaderSource = R"(
    ...
    void main() {
        color = texture(textureData, tCoord) * vert_color;
    }
)";
...
void InitVBO()
{
    ...
    Color colors[] = {
        HSV2RGB(300, 100, 100), HSV2RGB(0, 100, 100), HSV2RGB(60, 100, 100),
        HSV2RGB(60, 100, 100), HSV2RGB(0, 0, 100), HSV2RGB(300, 100, 100),
        HSV2RGB(240, 100, 100), HSV2RGB(120, 100, 100), HSV2RGB(0, 0, 0),
        HSV2RGB(120, 100, 100), HSV2RGB(240, 100, 100), HSV2RGB(180, 100, 100),

        HSV2RGB(0, 0, 0), HSV2RGB(0, 100, 100), HSV2RGB(60, 100, 100),
        HSV2RGB(60, 100, 100), HSV2RGB(120, 100, 100), HSV2RGB(0, 0, 0),
        HSV2RGB(240, 100, 100), HSV2RGB(0, 0, 100), HSV2RGB(300, 100, 100),
        HSV2RGB(0, 0, 100), HSV2RGB(240, 100, 100), HSV2RGB(180, 100, 100),

        HSV2RGB(180, 100, 100), HSV2RGB(0, 0, 100), HSV2RGB(60, 100, 100),
        HSV2RGB(60, 100, 100), HSV2RGB(120, 100, 100), HSV2RGB(180, 100, 100),
        HSV2RGB(240, 100, 100), HSV2RGB(0, 100, 100), HSV2RGB(300, 100, 100),
        HSV2RGB(0, 100, 100), HSV2RGB(240, 100, 100), HSV2RGB(0, 0, 0),
    };
